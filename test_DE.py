...
for ga_pop_size in ga_pop_size_list:
    for de_crossover_rate in de_crossover_rate_list:
        for de_mutation_rate in de_mutation_rate_list:
                ...
                for weight_tune_selection in weight_tune_selection_list:
                    ...
                    for run in tqdm(range(no_runs)):
                        ...
                        sgp = SimpleGP(fitness_function, functions, terminals,
                                       ...
                                       tournament_size=tournament_size, max_time=20,
                                       ga_population_size=ga_pop_size, genetic_algorithm=genetic_algorithm,
                                       de_mutation_rate=de_mutation_rate, de_recombination_rate=de_crossover_rate,
...
df.to_csv('results_DE.csv', index=False)
